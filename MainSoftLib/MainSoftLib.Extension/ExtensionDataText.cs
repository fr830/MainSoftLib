...
{
    public static class ExtensionDataText
    {
        private static char[] sevenBitDefault = new char[] {
            '@', '\x00a3', '$', '\x00a5', '\x00e8', '\x00e9', '\x00f9', '\x00ec', '\x00f2', '\x00c7', '\n', '\x00d8', '\x00f8', '\r', '\x00c5', '\x00e5',
        ...
        private static byte CharToSevenBitExtension(this char c)
        {
            switch (c)
            {
                case '[':
        ...
        public static string SeptetsToOctetsHex(this string data)
        {
            string str = string.Empty;
            string s = string.Empty;
            for (int i = 0; i < data.Length; i++)
            {
                string str3 = ExtensionDataType.IntToBinary((byte)data[i], 7);
                if ((i != 0) && ((i % 8) != 0))
                {
                    string str5 = str3.Substring(7 - (i % 8)) + s;
                    str = str + ExtensionDataType.IntToHex(ExtensionDataType.BinaryToInt(str5));
                }
                s = str3.Substring(0, 7 - (i % 8));
                if ((i == (data.Length - 1)) && (s != string.Empty))
                {
                    str = str + ExtensionDataType.IntToHex(ExtensionDataType.BinaryToInt(s));
                }
            }
            return str;
        }
        ...
        private static char SevenBitExtensionToChar(this byte b)
        {
            switch (b)
            {
                case 40:
        ...
        public static string SevenBitToString(this string s)
        {
        ...
        public static string StringTo7Bit(this string s)
        {
            bool flag;
