...
namespace MainSoftLib.Password
{
    public class MethodsPassword
    {
        ...
        public MethodsPassword(int longitudCaracteres)
        ...
        /// <exception cref="ArgumentOutOfRangeException">Se produce al intentar introducir un porcentaje de caracteres especiales mayor de 100</exception>
        /// 
        public MethodsPassword(int longitudCaracteres, int porcentajeMayusculas, int porcentajeSimbolos, int porcentajeNumeros)
        {
        ...
        public static string GetPassword()
        {
            ...
            MethodsPassword gp = new MethodsPassword();
        ...
        private void GeneraPassword()
        {
            ...
            int[] caracteresEspeciales = GetPosicionesCaracteresEspeciales(numMayusculas + numSimbolos + numNumeros);
