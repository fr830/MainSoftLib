...
{
    public partial class FromCaptchaSolver : Form
    {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                actual = MethodImagenFilter.Blur(actual);
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = MethodImagenFilter.SaturationCorrection(actual);                
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = MethodImagenFilter.Dilatation(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = MethodImagenFilter.BlobsFiltering(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = MethodImagenFilter.GaussianSharpen(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = MethodImagenFilter.Invert(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                if (actual != null)
                    resultado.Text = MethodCaptchaSolver.OCR(actual);
                else
        ...
        private void button26_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = MethodImagenFilter.Shrink(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button34_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = actual.Clone(new Rectangle(0, 0, actual.Width, actual.Height), System.Drawing.Imaging.PixelFormat.Format24bppRgb);
                actual = MethodImagenFilter.TirarPixelPretoSozinhoVertical(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button37_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = actual.Clone(new Rectangle(0, 0, actual.Width, actual.Height), System.Drawing.Imaging.PixelFormat.Format24bppRgb);
                actual = MethodImagenFilter.TirarPixelPretoEntreBranco2Horizontal(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button36_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = actual.Clone(new Rectangle(0, 0, actual.Width, actual.Height), System.Drawing.Imaging.PixelFormat.Format24bppRgb);
                actual = MethodImagenFilter.TirarPixelPretoEntreBranco3Horizontal(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button46_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = MethodImagenFilter.TirarBordaBaixa(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button50_Click(object sender, EventArgs e)
        {
            try
            {
                InsertarCambio("Mean");
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = MethodImagenFilter.Mean(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button51_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = MethodImagenFilter.BilateralSmoothing(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button70_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = actual.Clone(new Rectangle(0, 0, actual.Width, actual.Height), System.Drawing.Imaging.PixelFormat.Format24bppRgb);
                actual = MethodImagenFilter.TirarBordaRS(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button74_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = actual.Clone(new Rectangle(0, 0, actual.Width, actual.Height), System.Drawing.Imaging.PixelFormat.Format24bppRgb);
                actual = MethodImagenFilter.TirarBordaCima(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button76_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = actual.Clone(new Rectangle(0, 0, actual.Width, actual.Height), System.Drawing.Imaging.PixelFormat.Format24bppRgb);
                actual = MethodImagenFilter.Limpar2PX(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                anterior = MethodImagenFilter.CopyBitmap(actual);
                actual = actual.Clone(new Rectangle(0, 0, actual.Width, actual.Height), System.Drawing.Imaging.PixelFormat.Format24bppRgb);
                actual = MethodImagenFilter.PintarPixelPretoDeBranco2(actual);
                pictureBox1.Image = actual;
            }
            catch (Exception ex)
            {
